...
export async function extractInvoiceData(
  ...
  const response = await model.generateContent([
    ...
    {
      text: `You are an invoice/receipt data extractor. Extract the following from this image and return ONLY valid JSON with no markdown formatting, no code fences:
{
...
If the image is not a receipt/invoice, set confidence to "low" and extract what you can.`,
    },
  ]);
